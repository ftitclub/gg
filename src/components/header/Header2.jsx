  ...
  return (
    <header className="header-style-2">
      <div className="container d-flex justify-content-between align-items-center ">
        <div className="logo">
          <Link href="/">
            <a className="header2-logo">
              <img src="assets/images/icons/header1-logo.svg" alt="" />
            </a>
          </Link>
        </div>
        {currentRoute === "/index2" ? (
          <>
            <Link href="/contact">
              <a className="eg-btn btn--primary2 btn--lg d-lg-flex d-none">
          ...
          <Link href="/contact">
            <a className="eg-btn btn--primary-outline2 btn--lg2 d-lg-flex d-none">
              Connect Now
            </a>
          </Link>
        ) : (
